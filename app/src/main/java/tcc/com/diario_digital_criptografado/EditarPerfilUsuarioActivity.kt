            ...
            if(ConexaoUtil.estaConectado(this)){
                ...
                val timer = object: CountDownTimer(4000, 1000) {
                    ...
                    override fun onFinish() {
                        Toast.makeText(this@EditarPerfilUsuarioActivity, "Dados atualizados com sucesso.", Toast.LENGTH_SHORT).show()
                        intent = Intent(this@EditarPerfilUsuarioActivity, MeuPerfilActivity::class.java)
                        startActivity(intent)
                        finish()
                    }
                }
